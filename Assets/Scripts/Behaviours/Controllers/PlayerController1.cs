    ...
    public class PlayerController1 : MonoBehaviour
    {
        ...
        private IEnumerator CheckLife()
        {
            if (currentHealth <= 0)
            {
                ...
                _animator.SetBool("isRunningDogEnemy", false);
                inmng.enabled = false;
        ...
        {
            EnemyController1 other = collision.gameObject.GetComponent<EnemyController1>();
            if (other)
            {
        ...
        {
            bool isRunning = _animator.GetBool("isRunningDogEnemy");
            if (isRunning != true)
            {
                _animator.SetBool("isRunningDogEnemy", true);
            }
        }
